    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (qty === 0) {
                ...
                cartHover_existItem.find('.product-seleted p').text(response['cart'].price.toFixed(0) + ' $' + ' x ' + response['cart'].qty);
            }
            ...
            if (qty === 0) {
                ...
                cart_existItem.find('.total-price').text(numberWithCommas((response['cart'].price * response['cart'].qty).toFixed(0)) + ' $');
            }

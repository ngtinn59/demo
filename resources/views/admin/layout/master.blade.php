                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5"
                                         style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/abstract2.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/abstract3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image"
                                         style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/abstract4.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05"
                                         style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/city2.jpg');">
                                    </div>
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="front/img/user/{{ \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatar.jpg'}}"
                                             alt="">
                                        ...
                                        <div class="dropdown-menu-header">
                                            <div class="dropdown-menu-header-inner bg-info">
                                                <div class="menu-header-image opacity-2"
                                                     style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/city3.jpg');">
                                                </div>
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="front/img/user/{{ \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatar.jpg'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading">{{ \Illuminate\Support\Facades\Auth::user()->name ?? '' }}</div>
                                                                <div class="widget-subheading opacity-8">{{ \Illuminate\Support\Facades\Auth::user()->email ?? '' }}</div>
                                                            </div>
                                        ...
                                        <div class="d-none popover-custom-content">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                    <div class="menu-header-image opacity-1"
                                                         style="background-image: url('../../../../../../Downloads/CodeLean.vn Laravel Resources-20220902T074111Z-001/CodeLean.vn Laravel Resources/eProject_Sem2_Template_Admin/eProject_Sem2_Template_Admin/./dashboard/assets/images/dropdown-header/city5.jpg');">
                                                    </div>
                                                    <div class="menu-header-content text-dark">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left">
                                            <img width="42" class="rounded" src="front/img/user/{{ $user->avatar ?? 'default-avatar.jpg'}}"
                                                 alt="" />
                                        </div>
                                    </div>
                                    <div class="widget-content-left">
...
<script type="text/javascript" src="./dashboard/assets/scripts/jquery-3.2.1.min.js"></script>
